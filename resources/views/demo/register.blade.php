{{--
    ...
    Source: production/register.html in ColorlibHQ/gentelella.
...
<div class="auth-page">
  <div class="auth-card">
    ...
    <div class="auth-subtitle">Get started in less than a minute.</div>

    <form onsubmit="event.preventDefault(); window.location.href='index.html';">
      <div class="form-group">
        <label class="form-label" for="name">Full name</label>
        <div class="input-group">
          <svg class="input-icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="8" cy="5" r="3"/><path d="M2 14a6 6 0 0112 0"/></svg>
          <input type="text" id="name" class="form-control" placeholder="Aigars Silkalns" required>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          <input type="password" id="password" class="form-control" placeholder="At least 8 characters" minlength="8" required>
        </div>
        <div class="form-hint">8+ characters, mixed case + a number</div>
      </div>
