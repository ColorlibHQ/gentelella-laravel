{{--
    ...
    Source: production/other_charts.html in ColorlibHQ/gentelella.
...
@section('title', 'Other charts')
@section('page_key', 'other-charts')
@section('breadcrumb', 'Home > Charts > Other')
