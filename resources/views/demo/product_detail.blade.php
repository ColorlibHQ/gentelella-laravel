{{--
    ...
    Source: production/product_detail.html in ColorlibHQ/gentelella.
...
@section('title', 'AdminLTE Pro · Product')
@section('page_key', 'product')
@section('breadcrumb', 'Home > Storefront > AdminLTE Pro')
